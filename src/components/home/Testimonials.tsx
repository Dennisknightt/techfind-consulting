...
const testimonials = [
  ...
  {
    name: "Charlotte Webb",
    title: "Managing Partner, Marchetti & Webb",
    avatar: "CW",
    company: "🇬🇧 Legal Services, London",
    rating: 5,
    quote: "We competed against large global firms for every mandate. TechFind got us cited by ChatGPT as the leading M&A boutique in the City. The calibre of inbound enquiries has transformed our pipeline.",
  ...
  {
    name: "Tobias Krause",
    title: "VP Marketing, Operata GmbH",
    avatar: "TK",
    company: "🇩🇪 B2B SaaS, Berlin",
    rating: 5,
    quote: "European HR directors were asking AI for software recommendations and our competitors were getting all the citations. TechFind gave us a systematic strategy that now puts us in AI answers across 7 EU markets.",
    result: "+310% trial sign-ups",
  },
];
